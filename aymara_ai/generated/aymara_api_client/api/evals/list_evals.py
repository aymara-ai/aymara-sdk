...
from ...models.paged_eval_out_schema import PagedEvalOutSchema
...
) -> Optional[Union[ErrorResponseSchema, PagedEvalOutSchema]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PagedEvalOutSchema.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, PagedEvalOutSchema]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, PagedEvalOutSchema]
    """
