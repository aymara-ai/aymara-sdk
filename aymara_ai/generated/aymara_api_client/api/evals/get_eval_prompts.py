...
from ...models.paged_eval_prompt_schema import PagedEvalPromptSchema
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/v2/evals/{eval_uuid}/prompts",
        "params": params,
    }
...
) -> Optional[Union[ErrorResponseSchema, PagedEvalPromptSchema]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PagedEvalPromptSchema.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, PagedEvalPromptSchema]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, PagedEvalPromptSchema]
    """
