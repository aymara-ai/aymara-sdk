...
def _get_kwargs(
    eval_uuid: str,
    *,
    regenerate: Union[Unset, bool] = False,
    num_prompts: Union[Unset, int] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """Create Eval Questions
     ...
     Find or generate questions for an eval and return them.

    Args:
        eval_uuid: UUID of the eval to get or generate questions for
        regenerate: Whether to regenerate questions (will replace existing ones)
        num_prompts: Number of questions to generate (defaults to test.num_test_questions)
    ...
    Args:
        eval_uuid (str):
        regenerate (Union[Unset, bool]):  Default: False.
        num_prompts (Union[Unset, int]):
