...
from ...models.eval_in_schema import EvalInSchema
...
) -> Optional[Union[ErrorResponseSchema, EvalOutSchema]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = EvalOutSchema.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, EvalOutSchema]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    This function converts the EvalInSchema to TestInSchema and delegates to the create_test function.

    Args:
        body (EvalInSchema): Schema for configuring an Eval based on a eval_type.
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, EvalOutSchema]
    """
