...
) -> Optional[Union[ErrorResponseSchema, UploadFileResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, UploadFileResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    This function delegates to the get_image_presigned_urls function to get presigned URLs for file
    uploads.
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, UploadFileResponse]
    """
