...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/v2/eval-templates/{template_uuid}",
    }
...
) -> Optional[Union[ErrorResponseSchema, EvalTemplateSchema]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = EvalTemplateSchema.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, EvalTemplateSchema]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Eval Template
     ...
     Get a specific eval template by UUID.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, EvalTemplateSchema]
    """
