...
from ...models.eval_template_schema import EvalTemplateSchema
...
) -> Optional[Union[ErrorResponseSchema, List["EvalTemplateSchema"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = EvalTemplateSchema.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, List["EvalTemplateSchema"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List Eval Templates
     ...
     List all available eval templates.
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, List['EvalTemplateSchema']]
    """
