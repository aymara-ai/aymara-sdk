...
from ...models.eval_run_in_schema import EvalRunInSchema
from ...models.eval_run_turn_out_schema import EvalRunTurnOutSchema
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: EvalRunInSchema,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/v2/eval-runs/-/score-responses",
        "params": params,
    }
...
) -> Optional[Union[ErrorResponseSchema, EvalRunTurnOutSchema]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = EvalRunTurnOutSchema.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, EvalRunTurnOutSchema]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    This function is used to submit AI responses to the eval prompts.

    Args:
        workspace_uuid (Union[Unset, str]):
        is_sandbox (Union[Unset, bool]):  Default: False.
        body (EvalRunInSchema): Schema for creating or continuing an eval run.
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, EvalRunTurnOutSchema]
    """
