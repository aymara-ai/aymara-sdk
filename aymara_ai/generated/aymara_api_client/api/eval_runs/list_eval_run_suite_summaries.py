...
from ...models.paged_eval_run_suite_summary_out_schema import PagedEvalRunSuiteSummaryOutSchema
...
) -> Optional[Union[ErrorResponseSchema, PagedEvalRunSuiteSummaryOutSchema]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PagedEvalRunSuiteSummaryOutSchema.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, PagedEvalRunSuiteSummaryOutSchema]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, PagedEvalRunSuiteSummaryOutSchema]
    """
