...
from ...models.paged_eval_run_out_schema import PagedEvalRunOutSchema
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    eval_uuid: Union[Unset, str] = UNSET,
...
) -> Optional[Union[ErrorResponseSchema, PagedEvalRunOutSchema]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PagedEvalRunOutSchema.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, PagedEvalRunOutSchema]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, PagedEvalRunOutSchema]
    """
