...
from ...models.paged_eval_response_out_schema import PagedEvalResponseOutSchema
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/v2/eval-runs/{eval_run_uuid}/responses",
        "params": params,
    }
...
) -> Optional[Union[ErrorResponseSchema, PagedEvalResponseOutSchema]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PagedEvalResponseOutSchema.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, PagedEvalResponseOutSchema]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, PagedEvalResponseOutSchema]
    """
