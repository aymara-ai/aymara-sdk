...
from ...models.get_eval_run_image_presigned_urls_response import GetEvalRunImagePresignedUrlsResponse
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/v2/eval-runs/image/get-presigned-urls",
    }
...
) -> Optional[Union[ErrorResponseSchema, GetEvalRunImagePresignedUrlsResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetEvalRunImagePresignedUrlsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, GetEvalRunImagePresignedUrlsResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Eval Run Image Presigned Urls
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, GetEvalRunImagePresignedUrlsResponse]
    """
