...
) -> Optional[Union[ErrorResponseSchema, PagedScoreRunOutSchema]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, PagedScoreRunOutSchema]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, PagedScoreRunOutSchema]
    """
