...
) -> Optional[Union[ErrorResponseSchema, PagedAnswerOutSchema]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, PagedAnswerOutSchema]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, PagedAnswerOutSchema]
    """
