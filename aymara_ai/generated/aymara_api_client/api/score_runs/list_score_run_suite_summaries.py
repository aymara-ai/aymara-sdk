...
) -> Optional[Union[ErrorResponseSchema, PagedScoreRunSuiteSummaryOutSchema]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, PagedScoreRunSuiteSummaryOutSchema]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, PagedScoreRunSuiteSummaryOutSchema]
    """
