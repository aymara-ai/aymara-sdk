...
) -> Optional[Union[ErrorResponseSchema, PagedTestOutSchema]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponseSchema, PagedTestOutSchema]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponseSchema, PagedTestOutSchema]
    """
