...
class Status(str, Enum):
    ...
    @classmethod
    def from_api_status(
        cls, api_status: Union[TestStatus, ScoreRunStatus, ScoreRunSuiteSummaryStatus, ApiStatus]
    ) -> "Status":
        """
        ...
        elif isinstance(api_status, ApiStatus):
            status_mapping = {
                ApiStatus.CREATED: cls.PENDING,
                ApiStatus.PROCESSING: cls.PROCESSING,
                ApiStatus.FINISHED: cls.COMPLETED,
                ApiStatus.FAILED: cls.FAILED,
            }
